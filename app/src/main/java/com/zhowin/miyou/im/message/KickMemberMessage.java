package com.zhowin.miyou.im.message;
...
public class KickMemberMessage extends MessageContent {
    ...
    public static final Creator<KickMemberMessage> CREATOR = new Creator<KickMemberMessage>() {
        @Override
    ...
    public KickMemberMessage(byte[] data) {
        ...
        try {
            ...
            Log.e(TAG, "踢人 UnsupportedEncodingException ", e);
        }

        if (jsonStr == null) {
            Log.e(TAG, "踢人 jsonStr is null ");
            return;
        }
        ...
        try {
            ...
            if (jsonObj.has("type")) {
                ...
                Log.e(TAG, String.valueOf(jsonObj.getInt("type")));
            }

            if (jsonObj.has("operatorId")) {
                operatorId = jsonObj.getString("operatorId");
                Log.e(TAG, jsonObj.getString("operatorId"));
            }

            if (jsonObj.has("operatorName")) {
                operatorName = jsonObj.getString("operatorName");
                Log.e(TAG, jsonObj.getString("operatorName"));
            }

            if (jsonObj.has("roomId")) {
                roomId = jsonObj.getString("roomId");
                Log.e(TAG, jsonObj.getString("roomId"));
            }

        } catch (JSONException e) {
            Log.e(TAG, "踢人 JSONException byte[] data " + e.getMessage());
        }
    }
    ...
    public byte[] encode() {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(operatorId)) {
                ...
                Log.e(TAG, "operatorId " + operatorId);
            }
            if (!TextUtils.isEmpty(operatorName)) {
                jsonObj.put("operatorName", operatorName);
                Log.e(TAG, "operatorName " + operatorName);
            }
