...
public class SendGiftMessage extends MessageContent {
    ...
    public SendGiftMessage(byte[] data) {
        ...
        try {
            ...
            Log.e(TAG, "发送普通礼物 UnsupportedEncodingException ", e);
        }

        if (jsonStr == null) {
            Log.e(TAG, "发送普通礼物 jsonStr is null ");
            return;
        }
        ...
        try {
            ...
            if (jsonObj.has("content")) {
                ...
                Log.e(TAG, jsonObj.getString("content"));
            }

            if (jsonObj.has("tag")) {
                setTag(jsonObj.getString("tag"));
                Log.e(TAG, jsonObj.getString("tag"));
            }

        } catch (JSONException e) {
            Log.e(TAG, "发送普通礼物 JSONException byte[] data " + e.getMessage());
        }
    }
