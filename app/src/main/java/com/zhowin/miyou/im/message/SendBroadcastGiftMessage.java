...
public class SendBroadcastGiftMessage extends MessageContent {
    ...
    public SendBroadcastGiftMessage(byte[] data) {
        ...
        try {
            ...
            if (jsonObj.has("roomName")) {
                ...
                Log.e(TAG, jsonObj.getString("roomName"));
            }
            ...
            Log.e(TAG, "发送超级礼物 JSONException byte[] data " + e.getMessage());
        }
    }
    ...
    public byte[] encode() {
        ...
        try {
            ...
            Log.e(TAG, "发送超级礼物 JSONException encode " + e.getMessage());
        }

        try {
            return jsonObj.toString().getBytes("UTF-8");
        } catch (UnsupportedEncodingException e) {
            Log.e(TAG, "发送超级礼物 UnsupportedEncodingException ", e);
        }
        return null;
    }
