package com.zhowin.miyou.main.view;
...
public class VerificationCodeView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        containerEt = (LinearLayout) this.findViewById(R.id.llContainerLayout);
        et = (PwdEditText) this.findViewById(R.id.etPwdEditText);
